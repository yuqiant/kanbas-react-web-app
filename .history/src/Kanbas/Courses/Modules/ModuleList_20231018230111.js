    ...
    return (
        <div>
            ...
            <div class="list-group mb-4">
                <a href="#" class="list-group-item list-group-item-secondary">Resources</a>
                <a href="#" class="list-group-item list-group-item-secondary">Required Textbook</a>


                <a href="#" class="list-group-item list-group-item-secondary">Week 0 - INTRO</a>
                <a href="#" class="list-group-item list-group-item-secondary">Week 1 - HTML</a>
